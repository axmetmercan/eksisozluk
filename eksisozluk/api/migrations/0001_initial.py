    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_likes', models.IntegerField(default=0, verbose_name='User Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=65, verbose_name='Title')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.CharField(max_length=255, verbose_name='Post Copntent')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Created Date')),
                ('status', models.BooleanField(default=True)),
                ('like', models.IntegerField(verbose_name='Like Count')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='', max_length=80, verbose_name='Blog Title')),
                ('content', models.TextField(verbose_name='Blog Content Text')),
                ('status', models.BooleanField(default=True)),
                ('like', models.IntegerField(verbose_name='Total Likes of Blog Post')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Created Ddate')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
